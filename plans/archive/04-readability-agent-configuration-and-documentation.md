...
**Status: archived design record.** This preserves the original review, schema decisions, and implementation checkpoints; it is not an active task list. See [remaining Plan 04 work](../04-readability-agent-configuration-and-documentation.md), [Plan 05](../05-domain-layout-and-navigation.md) for the structural migration, and [maintained documentation](../../docs/README.md) for implemented behavior.
