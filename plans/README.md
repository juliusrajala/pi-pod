...
| [06 — Compiled CLI and platform distribution](06-compiled-cli-distribution.md)      | Planned                            | Secure compiled Linux release bundle, source/release bootstrap parity, and audited build-recipe distribution.      |
