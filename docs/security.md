...
- Interactive host auth stages only a selected native credential. Interactive Pi resource mounts are filtered and read-only; pi-pod never writes host Pi/OpenCode state back.
